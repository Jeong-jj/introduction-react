  ...
  return (
    <div id="career">
      ...
      <div className="introduce">
        ...
        <p>
          생명과학을 전공하고 세포를 다루는 연구원이란 꿈에서, 이제는 개발언어를
          다루는 <strong>Front-End 개발자</strong>란 꿈을 꾸고 있습니다.
        </p>
        <p>
        ...
        <p>
          ...
          공부한 내용과 작업한 내용을 '나를 위한 글을 쓴다'는 생각으로 블로그에
          글을 작성하고 있으며, 이후에도 필요할 때 이전 기록을 참고하며 익히고
          있습니다.
        </p>
      </div>
    </div>
